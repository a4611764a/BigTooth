...
public class JokesxuehuaView extends View {
	...
	public void setWH(int pW, int pH, float de) {
		...
		offsetX = new Integer[] { (int) (2 * de), (int) (-2 * de),
				(int) (-1 * de), 0, (int) (1 * de), (int) (2 * de),
				(int) (1 * de) };
		offsetY = new Integer[] { (int) (3 * de), (int) (5 * de),
				(int) (5 * de), (int) (3 * de), (int) (4 * de) };
	}

	public JokesxuehuaView(Context context) {
		super(context);
	}

	public JokesxuehuaView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public JokesxuehuaView(Context context, AttributeSet attrs) {
		super(context, attrs);

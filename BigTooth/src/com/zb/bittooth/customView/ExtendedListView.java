...
public class ExtendedListView extends ListView implements OnScrollListener {
	...
	public ExtendedListView(Context context, AttributeSet attrs, int defStyle) {
		...
		final int scrollBarPanelInAnimation = a.getResourceId(R.styleable.ExtendedListView_scrollBarPanelInAnimation, R.anim.mine_frame_drip_in_animation);
		final int scrollBarPanelOutAnimation = a.getResourceId(R.styleable.ExtendedListView_scrollBarPanelOutAnimation, R.anim.mine_frame_drip_out_animation);
		a.recycle();
